...
impl PlatformInfo {
    ...
    fn add_library_packages(&self, packages: &mut Vec<Package>) {
        ...
        if let Some(version) = phpx_embed::Php::icu_version() {
            if !version.is_empty() {
        ...
        // libxml
        if let Some(version) = phpx_embed::Php::libxml_version() {
            if !version.is_empty() {
        ...
        if let Some(version_text) = phpx_embed::Php::openssl_version() {
        ...
        // PCRE
        if let Some(version) = phpx_embed::Php::pcre_version() {
            if !version.is_empty() {
        ...
        // zlib
        if let Some(version) = phpx_embed::Php::zlib_version() {
            if !version.is_empty() {
        ...
        // curl
        if let Some(version) = phpx_embed::Php::curl_version() {
            if !version.is_empty() {
